...
if __name__ == "__main__":
	...
	send_human_move_command(box="pink_box_2", loc="cell_0")
	send_commands_to_robot(obj_id='',start_loc='Else_1', end_loc='cell_7')
	send_human_move_command(box="pink_box_3", loc="cell_8")
	stow_robot()
