...
if __name__ == "__main__":
	...
	send_commands_to_robot(obj_id='',start_loc='Else_2', end_loc='cell_3')

	send_commands_to_robot(obj_id='',start_loc='Else_4', end_loc='cell_2')
	 
	send_commands_to_robot(obj_id='',start_loc='Else_3', end_loc='cell_8')
