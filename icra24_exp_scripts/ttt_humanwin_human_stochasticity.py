...
if __name__ == "__main__":
	...
	send_commands_to_robot(obj_id='',start_loc='Else_0', end_loc='cell_4')
	 
	send_commands_to_robot(obj_id='',start_loc='Else_1', end_loc='cell_0')

	send_commands_to_robot(obj_id='',start_loc='Else_2', end_loc='cell_2')

	send_commands_to_robot(obj_id='',start_loc='Else_4', end_loc='cell_6')
