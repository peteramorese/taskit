...
int main(int argc, char** argv) {
	...
	std::shared_ptr<GripperHandler<GripperUse::FrankaHand>> gripper_handler = std::make_shared<GripperHandler<GripperUse::FrankaHand>>(TASKIT_FRANKA_GRIPPER_TOPIC, 5.0);
