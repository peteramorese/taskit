...
'''
In this strategy the human is cooperative and moves the R block to one position
 to its left after each robot turn.  The Robot accordingly finishes the task in the
 Human region 
'''
import sys
...
if __name__ == "__main__":
	...
	# human moves R when transfering to L1 
